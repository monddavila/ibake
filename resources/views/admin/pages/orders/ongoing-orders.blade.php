...
<body>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                      ...
                      @if ($ongoingOrders->isEmpty())
                          <tr>
                              <td colspan="11" class="text-center">
                                  <div class="order-info">No Ongoing Orders Available</div>
                              </td>
                          </tr>
                      @else
                  ...
                  {{ $ongoingOrders->links() }} <!-- Custom Cake Orders Pagination Links -->
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table" id="orders-table">
                      ...
                      <tbody>
                      @if ($ongoingCustomOrders->isEmpty())
                          <tr>
                              <td colspan="11" class="text-center">
                                  <div class="order-info">No Ongoing Orders Available</div>
                              </td>
                      ...
                      @else
                        ...
                        @foreach ($ongoingCustomOrders as $order)
                          <tr>
                  ...
                  {{ $ongoingCustomOrders->links() }} <!-- Custom Cake Orders Pagination Links -->
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    button.addEventListener("click", function (event) {
        if (!confirm("Warning: Marking the order as ready for pick-up or delivery will notify the customer that their order is ready. Make sure the order is ready before proceeding. Proceed?")) {
