          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.addProducts') }}" class="btn btn-primary btn-fw">+ Add Category</a>
              </div>
              <div class="col-lg-3">
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead>
                    <tr>
                      <th class="sortable col-lg-3" id="sort-name" data-sort="name">Category Name</th>
                      <th class="sortable" id="sort-price" data-sort="price">Description</th>
                      <th class="sortable" id="sort-category" data-sort="category">Parent ID</th>
