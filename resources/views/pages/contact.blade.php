...
@include('FrontEnd.header2')
    ...
    <section class="contact-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Our Contacts</h2>
                <div class="text">Got a question or need help placing an order? Our friendly customer service team is here to assist you! Get in touch with us through our convenient contact page, where you can easily send us a message, give us a call, or connect with us on social media.
                    <br> We're dedicated to making your cake ordering experience as smooth and enjoyable as possible, and we're always happy to hear from our customers. So don't hesitate to reach out - we're here to help!</div>
            </div>
                ...
                <div class="column col-xl-3 col-lg-6 col-md-6 col-sm-12 order-3">
                    <div class="inner-column">
                        ...
                        <ul class="contact-info">
                            ...
                            <li><a href="tel:+639064300383">+63 9064300383</a><br><a href="tel:12032842919">+1 203-284-2919</a></li>
                            <li><a href="mailto:info@ibake.com">info@ibake.com</a><br> <a href="mailto:sales@ibake.com">sales@ibake.com</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="map-section">
        <iframe id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1912.8948766379704!2d121.15385758690918!3d16.486180259974827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.
