    ...
    <div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="row">
                    ...
                    <div class="image-column col-lg-4 col-md-12 col-sm-12">
                        <div class="image-box">
                            <figure class="image"><img src="images/profile/jankevin-2.png" alt=""></figure>
                    ...
                    <div class="content-column col-lg-8 col-md-12 col-sm-12 order-2">
                        <div class="inner-column">
                            <div class="content">
                                <h3 class="name">Jan Kevin</h3>
                                <span class="designation">Owner and Head Pastry Chef</span>
        ...
        <section class="team-section">
            <div class="auto-container">
                <div class="sec-title text-center">
                    ...
                    <h2>Dedication</h2>
                    <div class="text">A dedicated and passionate baker, committed to delivering the highest quality
                        baked goods and excellent customer service to his customers. With years of experience and a deep
                        love for his craft, he continues to innovate and improve his recipes, ensuring that every
                        product that leaves his bakery is a true masterpiece.</div>
                </div>
            </div>
        </section>
        <!--Pitch Section -->
        ...
        <section class="chef-section-two">
            <div class="shape_wrapper shape_one">
                <div class="shape_inner menu_wave" style="background-image: url(images/background/background-8.png);">
            ...
            <div class="auto-container">
                <div class="row">
                    <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                        <div class="inner-column">
                            <div class="content">
                                ...
                                <h4>The Masterchef</h4>
                                <p>Jan Kevin's passion for baking is the driving force behind iBake - Tiers of Joy's
                                    success. His dedication to his craft is reflected in every product he creates, from
                                    his customized cakes and pastries to his artisan bread and cupcakes. With his
                                    attention to detail and commitment to excellence, Jan Kevin continues to push the
                                    boundaries of what is possible in the world of baking.</p>
                                <div class="divider"><img src="images/icons/icon-devider-light.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <figure class="image"><img src="images/profile/jankevin-4.png" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
