...
<!-- End Team Section -->
    ...
    <section class="team-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Dedication</h2>
                <div class="text">A dedicated and passionate baker, committed to delivering the highest quality baked goods and excellent customer service to his customers. With years of experience and a deep love for his craft, he continues to innovate and improve his recipes, ensuring that every product that leaves his bakery is a true masterpiece.</div>
            </div>
        </div>
    </section>
    <!--Pitch Section -->
    ...
    <section class="chef-section-two">
        <div class="shape_wrapper shape_one">
            <div class="shape_inner menu_wave" style="background-image: url(images/background/background-8.png);"><div class="overlay"></div></div>
        </div>
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column">                    
                        <div class="content">
                            ...
                            <p>Jan Kevin's passion for baking is the driving force behind iBake - Tiers of Joy's success. His dedication to his craft is reflected in every product he creates, from his customized cakes and pastries to his artisan bread and cupcakes. With his attention to detail and commitment to excellence, Jan Kevin continues to push the boundaries of what is possible in the world of baking.</p>
            ...
            <div class="testimonial-carousel-two owl-carousel owl-theme default-dots no-arrows text-center">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        ...
                        <div class="text">Quisque eros ligula, tincidunt eget feugiat non, suscipit a odio. Morbi mattis.</div>
