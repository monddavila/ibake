...
<body>
    <div class="page-wrapper">
        ...
        <!-- Portfolio Sections -->
        <section class="portfolio-section alternate2 portfolio-masonry">
            <div class="auto-container">
                <div class="row masonry-items-container">
                    <!-- Portfolio Block -->
                    <div class="portfolio-block masonry-item col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="https://via.placeholder.com/300x300" alt="">
                                </figure>
                            </div>
                    ...
                    <!-- Portfolio Block -->
                    <div class="portfolio-block masonry-item col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="https://via.placeholder.com/620x640" alt="">
                                </figure>
                            </div>
                            <div class="portfolio-hover">
                                <div class="hover-effect">
                                ...
                                <a href="https://via.placeholder.com/620x640" class="lightbox-image link"
                                    data-fancybox="portfolio"></a>
                                <h3><a href="portfolio-single.html">Sit porta <br>penatibus</a></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portfolio-block masonry-item col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <a href="https://via.placeholder.com/300x300" class="lightbox-image link"
                                    data-fancybox="portfolio"></a>
                                <h3><a href="portfolio-single.html">Consequat <br>augue</a></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portfolio-block masonry-item col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <a href="https://via.placeholder.com/620x640" class="lightbox-image link"
                                    data-fancybox="portfolio"></a>
                                <h3><a href="portfolio-single.html">Quis nulla nulla</a></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portfolio-block masonry-item col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <div class="portfolio-hover">
                                ...
                                <a href="https://via.placeholder.com/300x300" class="lightbox-image link"
                                    data-fancybox="portfolio"></a>
                                <h3><a href="portfolio-single.html">Eu tellus eget</a></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portfolio-block masonry-item col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="https://via.placeholder.com/300x620" alt="">
                                </figure>
                            </div>
                            <div class="portfolio-hover">
                                <div class="hover-effect">
